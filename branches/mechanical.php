...
<div class="main">
    <div class="content">
    	<div class="content_top">
    		<div class="heading">
    		<h3>BOOKS</h3><h6>MECHANICAL DEPARTMENT</h6>
    		</div>
    		
    		
    		<div class="page-no"><ul>
    				<li>[<a id="mechanicalgad" name="overall/books.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
	      ...
	      <div class="section group">
			  ...
			  $books=mysql_query("SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Books' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>GADGETS</h3><h6>MECHANICAL DEPARTMENT</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="mechanicalgad" name="overall/gadgets.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $gadget=mysql_query("SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Gadgets' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  ...
			  while($gadgetd['sno']=mysql_fetch_array($gadget))
			  {
				  ?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a  style="cursor:pointer;" onclick=showproduct("<?php echo $gadgetsd['sno'];?>")><img src="products/<?php echo $gadgetd['attachment'];?>" width="200px" height="200px"/></a>
					<?php 
					...
					<?php } ?>
					<h2><?php echo $gadgetd['sno'];['name'];?> </h2>
					 <p>by <?php echo $gadgetd['sno'];['posted_by'];?></p>
					 <p><span class="price">Rs <?php echo $gadgetd['sno'];['cost'];?> /-</span></p>
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>ARTS</h3><h6>MECHANICAL DEPARTMENT</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="mechanicalgad" name="overall/arts.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $arts=mysql_query("SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Arts' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>OTHERS</h3><h6>MECHANICAL DEPARTMENT</h6>
    		</div>
    	
    		<div class="page-no"><ul>
    				<li>[<a id="mechanicalgad" name="overall/others.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $others=mysql_query("SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Others' && visibility='1' ORDER BY sno DESC LIMIT 12");
