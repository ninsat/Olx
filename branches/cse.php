...
<div class="main">
    <div class="content">
    	<div class="content_top">
    		<div class="heading">
    		<h3>BOOKS</h3><h6>CSE DEPARTMENT</h6>
    		</div>
    		
    		
    		<div class="page-no"><ul>
    				<li>[<a id="csegad" name="overall/books.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>GADGETS</h3><h6>CSE DEPARTMENT</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="csegad" name="overall/gadgets.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>ARTS</h3><h6>CSE DEPARTMENT</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="csegad" name="overall/arts.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>OTHERS</h3><h6>CSE DEPARTMENT</h6>
    		</div>
    	
    		<div class="page-no"><ul>
    				<li>[<a id="csegad" name="overall/others.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
