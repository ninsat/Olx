...
<div class="main">
    <div class="content">
    	<div class="content_top">
    		<div class="heading">
    		<h3>BOOKS</h3><h6>PUC</h6>
    		</div>
    		
    		
    		<div class="page-no"><ul>
    				<li>[<a id="pucgad" name="overall/books.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
	      ...
	      <div class="section group">
			  ...
			  $books=mysql_query("SELECT * FROM products WHERE branchcat='PUC' && procat='Books' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>GADGETS</h3><h6>PUC</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="pucgad" name="overall/gadgets.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $gadget=mysql_query("SELECT * FROM products WHERE branchcat='PUC' && procat='Gadgets' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>ARTS</h3><h6>PUC</h6>
    		</div>
    		
    		<div class="page-no"><ul>
    				<li>[<a id="pucgad" name="overall/arts.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $arts=mysql_query("SELECT * FROM products WHERE branchcat='PUC' && procat='Arts' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
    		<div class="heading">
    		<h3>OTHERS</h3><h6>PUC</h6>
    		</div>
    	
    		<div class="page-no"><ul>
    				<li>[<a id="pucgad" name="overall/others.php" style="cursor:pointer;" onclick="load_page(this.name,this.id)"> show more>>></a >]</li>
    				</ul></p>
    		</div>
    		<div class="clearfix"></div>
    	</div>
	      <div class="section group">
			  ...
			  $others=mysql_query("SELECT * FROM products WHERE branchcat='PUC' && procat='Others' && visibility='1' ORDER BY sno DESC LIMIT 12");
